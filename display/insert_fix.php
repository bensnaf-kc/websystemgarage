...
$bmw;$mercedes;$toyota;$honda;$isuzu;$mazda;$mitsubishi;$ford;
$hyundai;$volkswagen;$chevrolet;$suzuki;$mg;$kawasaki;$lexus;$ducati;$proton;
$id = $_GET['id_fix'];
?>
                                ...
                                <form action="add_car.php?id_fix=<?=$id;?>" class="was-validated" method="POST"
                                    ...
                                    <div class="row gx-4 mb-4">
                                        <div class="col-md-3">
                                            ...
                                            <input class="form-control" id="numbercar" type="text" placeholder=""
                                                name="numbercar" required />
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" id="series" name="series" placeholder="sdss"
                                    ...
                                    <div class="row gx-4 mb-3">
                                        ...
                                        <div class="col-md-4 ">
                                            <label for="info" class=" col-form-label">สาเหตุ/อาการ:</label>
                                            <input type="text" class="form-control" id="info" placeholder="" name="info"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-row">
