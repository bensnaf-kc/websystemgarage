<ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">ข้อมูลรถยนต์</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">ข้อมูลลูกค้า</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">ประกันภัย/เครม</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-paybuy-tab" data-bs-toggle="pill" data-bs-target="#pills-paybuy" type="button" role="tab" aria-controls="pills-paybuy" aria-selected="false">การชำระเงิน</button>
    </li>
</ul>
<div class="tab-content" id="pills-tabContent">
        ...
        <div class="card-body">
            <div class="card bg-light">
                ...
                <div class="card-body">
                    ...
                    ?>
                        <form action="updatecar.php?id_fix=<?= $id; ?>&id_car=<?= $idcar; ?>" method="POST" enctype="multipart/form-data">
                            <div class="row gx-4 mb-3">
                                <div class="col-md-3">
                                    <label for="101">หมายเลขทะเบียน:</label>
                                    <input type="text" value="<?= $rowz['c_number']; ?>" id="c_number" name="c_number" class="form-control">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" value="<?= $rowz['c_series']; ?>" class="form-control" id="c_series" name="c_series">
                                </div>
                                <div class="col-md-3">
                                    <label for="">รุ่น:</label><br>
                                    <input type="text" value="<?= $rowz['c_gen']; ?>" class="form-control" id="c_gen" name="c_gen">
                                </div>
                                <br>
                            </div>
                            <div align="right">
                            ...
                            <div class="row gx-4 md-4">
                                <div class="col-md-3">
                                    ...
                                    while ($row_info = mysqli_fetch_array($qty_info)) { ?>
                                        <input type="text" value="<?= $row_info['info_name']; ?>" class="form-control" id="info_car" name="info_car">
                                    <?php } ?>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="row gx-4 md-4">
                                        <div class="col-md-2">
                                            ...
                                            while ($row_info_id = mysqli_fetch_array($qty_info_id)) { ?>
                                                <button class="btn btn-outline-warning shadow lift" type="button" data-bs-toggle="modal" data-bs-target="#infocar<?= $row_info_id[0]; ?>">แก้ไข</button><br>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <button class="btn btn-info shadow lift" type="button" data-bs-toggle="modal" data-bs-target="#infocar">+
    ...
    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
        <div class="card-body">
            <div class="card bg-light">
                <div class="card-header text-dark">รายละเอียดประกันภัย <a href="insert_insurance.php?id_car=<?= $idcar; ?>&id_fix=<?= $id; ?>" class="btn btn-primary btn-sm">+ เพิ่มประกัน/เครม</a><a href="bill_insu.php?id_fix=<?= $id; ?>&id_car=<?= $idcar; ?>" type="button" class="btn btn-info btn-sm shadow lift">พิมพ์</a></div>
                <div class="card-body">
                    <div class="card-body">
                        <form action="edit_insr.php?id_fix=<?= $id ?>&id_car=<?= $idcar; ?>" method="POST" enctype="multipart/form-data">
                            <?php
                                ...
                                <div class="row gx-4 md-4">
                                    <div class="col-md-3">
                                        <label for="101">บริษัทประกันภัย
                                            :</label>
                                        <input type="text" id="c_name" name="c_name" class="form-control" value="<?= $row_in[2]; ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="">หมายเลขกรมธรรม์
                                            :</label><br>
                                        <input type="text" class="form-control" id="c_add" name="c_add" value="<?= $row_in[3]; ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="">วันที่เริ่มคุ้มครอง
                                            :</label><br>
                                        <input type="date" class="form-control" onkeyup="autoTab(this)" id="c_com" name="c_com" value="<?= $row_in[4]; ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="">วันที่หมดอายุ
                                            :</label><br>
                                        <input type="date" value="<?= $row_in[5]; ?>" class="form-control" id="c_out" name="c_out">
                                    </div>
                                </div><br>
                                <div class="row gx-4 md-4">
                                    <div class="col-md-3">
                                        <label for="">หมายเลขเคลม
                                            :</label><br>
                                        <input type="text" value="<?= $row_in[6]; ?>" class="form-control" id="c_num" name="c_num">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="">ฝั่งผู้เอาประกัน
                                            :</label><br>
                                        <input type="text" value="<?= $row_in[7]; ?>" class="form-control" id="c_peo" name="c_peo">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="">วันที่ออกเอกสาร
                                            :</label><br>
                                        <input type="date" value="<?= $row_in[5]; ?>" class="form-control" id="c_date" name="c_date">
                                    </div>
                                </div>
                                <div align="right">
                                    <button class="btn btn-warning shadow lift" type="submit">แก้ไข</button>
                        ...
                        <div class="row">
                                        ...
                                        <div class="row gx-4 ">
                                            <div class="col">
                                                <?php while ($row_insu = mysqli_fetch_array($qty)) { ?>
                                                    <label for="" class="text-xs text-red">รายการที่ <?= $n++; ?></label><input type="text" value="<?= $row_insu['infois_name']; ?>" class="form-control">
                                                <?php } ?>
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <?php while ($row_amot = mysqli_fetch_array($qty_amot)) { ?>
                                                <label for="" class="text-xs text-red"></label><input type="text" value="<?= $row_amot['infois_amount']; ?>" class="form-control">
                                            <?php } ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <?php while ($row_price = mysqli_fetch_array($qty_price)) { ?>
                                                <label for="" class="text-xs text-red"></label><input type="text" value="<?= $row_price['infois_price']; ?>" class="form-control">
                                            <?php } ?>
                                        </div>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="col-md-1">
                                ...
                                if ($res == 0) {
                                    ...
                                    <?php while ($row_ma = mysqli_fetch_array($qty_ma)) { ?>
                                        <div class="row gx-4 ">
                                            <div class="col-md-2">
                                                <label for="" class="text-xs text-red"></label><button class="btn btn-outline-warning shadow lift" type="button" data-bs-toggle="modal" data-bs-target="#editinsu<?= $row_ma[0]; ?>">แก้ไข</button>
                                            </div>
                                        </div>
                                        <!-- edit Modal inso_info-->
                                        <div class="modal fade" id="editinsu<?= $row_ma[0]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="edit_infoinsu.php?id_fix=<?= $id; ?>&id_car=<?= $idcar; ?>" method="post">
                                                            <?php
                                                            ...
                                                            ?>
                                                                <div class="row">
                                                                    ...
                                                                    <input type="text" class="form-control" value="<?= $row_edit['infois_name']; ?>"><br>
                                                                    <label for="">จำนวน:</label><br>
                                                                    <input type="number" class="form-control" value="<?= $row_edit['infois_amount']; ?>"><br>
                                                                    <label for="">ราคา:</label><br>
                                                                    <input type="number" class="form-control" value="<?= $row_edit['infois_price']; ?>"><br>
                                                                </div>
                                                            <?php } ?>
                            ...
                            <div align="right">
                                <button class="btn btn-primary shadow lift" type="button" data-bs-toggle="modal" data-bs-target="#insu">เพิ่มสาเหตุ</button>
                            </div>
                            <br>
                            </form>
                        </div>
                        <hr>
                        <div class="row">
                            <label for="">รูปภาพหลักฐาน : ใบเครมลูกค้า <button class="btn btn-warning shadow lift" type="button" data-bs-toggle="modal" data-bs-target="#insertpic">+
                                    เพิ่มรูปภาพ</button></label><br>
                            <?php
                                if ($row_in['sr_pic'] !== 0) {
                            ?>
                                <br>
                                <img src="assets/img/insu/<?= $row_in['sr_pic']; ?>" alt="" style="width:200px;height:auto;">
                            <?php
                                } else {
                            ?>
    ...
    <div class="tab-pane fade" id="pills-paybuy" role="tabpanel" aria-labelledby="pills-paybuy-tab">
        <div class="card-body">
            <div class="card bg-light">
                <div class="card-header text-dark">รายละเอียดการชำระเงิน &nbsp;<button class="btn bg-blue text-white shadow lift" type="button" data-bs-toggle="modal" data-bs-target="#Deposit">+ เพิ่มค่ามัดจำ</button>&nbsp;<button class="btn bg-blue text-white  shadow lift" type="button" data-bs-toggle="modal" data-bs-target="#pay-repair">+ เพิ่มค่าซ่อม</button></div>
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">หลักฐานค่ามัดจำ</button>
                            <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">หลักฐานค่าซ่อม</button>
                        </div>
                                ...
                                if ($row_pay['pay_pic'] == 0) { ?>
                                    <div class="row gx-4">
                                        <div class="col-md-4">
                                            ...
                                            <button class="btn btn-warning btn-sm shadow lift" type="button" data-bs-toggle="modal" data-bs-target="#deposit-insert">เพิ่มรูปภาพ</button>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="">ค่ามัดจำ(บ.):</label><br>
                                            <label for="" class="text-orange"><?= $row_pay['pay_price']; ?>.00</label>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            ?>
                                            <label for="" class="text-blue"><?= $sum[0] - $row_pay['pay_price'] ?>.00</label>
                                        </div>
                                    </div>
                                <?php
                                } else { ?>
                                    <div class="row gx-4">
                                        <div class="col-md-4">
                                            ...
                                            <img src="assets/img/deposit/<?= $row_pay['pay_pic']; ?>" style="height: 100; width: 100px;"><br><br>
    ...
    <div class="tab-pane fade" id="pills-fix" role="tabpanel" aria-labelledby="pills-fix-tab">
        <div class="card-body">
            <div class="card bg-light">
                <div class="card-header text-dark">รายละเอียดรายการซ่อม &nbsp;<a href="insert_checkcar.php?id_car=<?= $id; ?>&id_fix=<?= $idcar; ?>" class="btn btn-primary btn-sm shadow lift">+เพิ่มข้อมูล</a></div>
                <div class="card-body">
...
<div class="modal fade" id="infocar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">ปิด</button><button class="btn btn-primary shadow lift" type="submit">บันทึก</button></form>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="insu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">ปิด</button><button class="btn btn-primary" type="submit">เพิ่ม</button>
            </div>
        </div>
    </div>
</div>
<!-- insertpic Modal -->
<div class="modal fade" id="insertpic" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="button">Save
                    changes</button></div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="fixcar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer"><button class="btn btn-secondary shadow lift" type="button" data-bs-dismiss="modal">ปิด</button><button class="btn btn-primary shadow lift" type="button">บันทึก</button></form>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="Deposit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="deposit.php?id_fix=<?= $id; ?>&id_car=<?= $idcar; ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div>
                        <label for="">รูปภาพหลักฐาน</label>la
                        <input type="file" name="pic" id="pic" class="form-control">
                    </div>
            </div>
            <div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">ปิด</button><button class="btn btn-primary shadwo lift" type="submit">บันทึก</button></form>
            </div>
        </div>
    </div>
</div>
<!-- edit picture deposit -->
<div class="modal fade" id="deposit-insert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <form action="add_picdepo.php?id_fix=<?= $id; ?>&id_car=<?= $idcar; ?>" method="post" enctype="multipart/form-data">
                        <label for="">เพิ่มหลักฐาน:</label>
                        <input type="file" name="pic" id="pic" class="form-control">
                </div>
            </div>
            <div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">ปิด</button><button class="btn btn-primary" type="submit">บันทึก</button></form>
...
<!-- pay repair -->
<div class="modal fade" id="pay-repair" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">ปิด</button><button class="btn btn-primary" type="button">บันทึก</button></form></div>
        </div>
    </div>
</div>