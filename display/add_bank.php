...
<?php
    ...
    $sql = "INSERT INTO bank (bank_id, user_id, bank_npay, bank_nowner, bank_numower) 
            VALUES (NULL,'$id','$bank','$nameowner','$numowner')";
    $query = mysqli_query($mysqli,$sql);
    
    if ($query) {
        header("refresh:1;url=setting-financial.php");  
    }else{
